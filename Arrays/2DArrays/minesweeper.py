"""
Asign numbers in minesweeper
Ex: thes size of the filed is 3x4 and there are bomob at position [0,0]
(row_index=0, column index=0) and [0,1](row_index=0, column index=1)
